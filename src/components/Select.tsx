...
const Select = <T extends FieldValues, TValue extends string>({
  ...
  return (
    <div>
      <select
        className="block min-w-max rounded-md border-0 py-1.5 pl-3 pr-10 ring-1 ring-inset ring-neutral-300 focus:ring-2 focus:ring-podmod md:text-sm md:leading-6 dark:bg-neutral-800"
        id={id}
        {...register(id)}
      >
