...
import feed from "@shared/schemas/feed";
...
const MainPage = ({ initialFeedId }: MainPageProps) => {
  ...
  if (loading) {
    return (
      <div className="xs:text-2xl flex min-h-screen w-full justify-center px-8 py-24 text-xl font-extrabold">
        Loading Feed Data...
      </div>
    );
  }
        ...
        <div className="flex max-w-5xl flex-col justify-center gap-12">
          <div className="flex max-w-5xl flex-wrap justify-between gap-6 sm:flex-nowrap">
            <div className="flex gap-2">
              <a
                className="focus-visible:outline-podmod rounded focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2"
                href="/"
              >
                <h1 className="text-podmod xs:text-5xl text-3xl font-extrabold">podmod.app</h1>{" "}
              </a>
              <h1 className="text:lg xs:text-xl font-extrabold">BETA</h1>
            </div>
