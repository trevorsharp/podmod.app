...
const CopyFeedButton = ({ modConfig }: ButtonProps) => {
  ...
  return (
    <button
      className="bg-podmod hover:bg-podmod-dark focus-visible:outline-podmod h-fit w-full rounded-md px-4 py-3 text-sm font-semibold text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 sm:w-48"
      type="button"
